...
Correcció valors atípics de les columnes MinTemp, MaxTemp , Temp9am i Temp3pm. Dubte amb si deuríem de corregir les altres columnes?.


```{r Correcció valors atípics- outliers}
# Apliquem una simple funció per a substituir tots els valors superiors a 100 per NA
